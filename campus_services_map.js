...
*/
 ...
 function initialize() {
   ...
   //  *** Campus Services/Green Markers start ***  //
   ...
   campusStoreMarker.addListener('mouseover', function() {
     modifyPinLabel(1, "Campus Services", campusStoreObj.linkName);
     $("#VenueTextBox").hide();
   });
   // Click Listener for Pin Labels
   ...
   publicSafetyMarker.addListener('mouseover', function() {
     modifyPinLabel(1, "Campus Services", publicSafetyObj.linkName);
     $("#VenueTextBox").hide();
   });
   // Click Listener for Pin Labels
   ...
   supercopyMarker.addListener('mouseover', function() {
     modifyPinLabel(1, "Campus Services", superCopyObj.linkName);
     $("#VenueTextBox").hide();
   });
   // Click Listener for Pin Labels
   ...
   universityRecreationMarker.addListener('mouseover', function() {
     modifyPinLabel(2, "Event Venues", universityRecreationObj.linkName);
     $("#VenueTextBox").hide();
   });
   // Click Listener for Pin Labels
   ...
   theBottomLineMarker.addListener('mouseover', function() {
     modifyPinLabel(0, "Redhawk Dining", theBottomLineObj.linkName);
     $("#VenueTextBox").hide();
   });
   // Click Listener for Pin Labels
   ...
   theByteMarker.addListener('mouseover', function() {
     modifyPinLabel(0, "Redhawk Dining", theByteObj.linkName);
     $("#VenueTextBox").hide();
   });
   // Click Listener for Pin Labels
   ...
   theSideBarMarker.addListener('mouseover', function() {
     modifyPinLabel(0, "Redhawk Dining", theSideBarObj.linkName);
     $("#VenueTextBox").hide();
   });
   // Click Listener for Pin Labels
   ...
   stcnDiningMarker.addListener('mouseover', function() {
     modifyPinLabel(0, "Redhawk Dining", stcnDiningObj.linkName);
     $("#VenueTextBox").hide();
   });
   // Click Listener for Pin Labels
